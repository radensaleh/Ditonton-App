...
void main() {
  ...
  group('get Now Playing Movies', () {
    final tMovieList = MovieResponse.fromJson(
            json.decode(readJson('helper/dummy_data/now_playing.json')))
        .movieList;
  ...
  group('get movie detail', () {
    ...
    final tMovieDetail = MovieDetailResponse.fromJson(
        json.decode(readJson('helper/dummy_data/movie_detail.json')));
  ...
  group('search movies', () {
    final tSearchResult = MovieResponse.fromJson(json
            .decode(readJson('helper/dummy_data/search_spiderman_movie.json')))
        .movieList;
